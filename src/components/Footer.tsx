      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href={AI_TOOLS_URL}>More Free AI Web Tools</FooterLink>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="https://aiwebtools.lovable.app/?via=aiwebtools">Terms of Service</FooterLink>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-white/10 gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © 2025 <a href={AI_TOOLS_URL} className="hover:text-neon-cyan transition-colors" title="AI Web Tools - Free AI Tools Platform">AI WEB TOOLS LLC</a> - Leading provider of free AI tools and AI web tools. All rights reserved.
          </p>
          
          <a 
            href={AI_TOOLS_URL}
            className="flex items-center gap-2 bg-gradient-to-r from-neon-cyan to-neon-magenta text-black font-medium px-4 py-2 rounded-full text-sm hover:opacity-90 transition-opacity whitespace-nowrap"
